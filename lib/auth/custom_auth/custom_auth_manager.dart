...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    gogreenAuthUserSubject.add(
      GogreenAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<GogreenAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  GogreenAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = GogreenAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    gogreenAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
